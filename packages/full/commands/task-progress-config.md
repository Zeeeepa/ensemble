...
/ensemble:task-progress-config multiplexer wezterm    # Set multiplexer
/ensemble:task-progress-config direction bottom       # Set split direction
/ensemble:task-progress-config percent 30             # Set pane size
/ensemble:task-progress-config autoclose 30           # Auto-close after 30 seconds
```
...
```
/ensemble:task-progress-config multiplexer wezterm
...
```
/ensemble:task-progress-config auto-hide false
```

**Reset to defaults:**
```
/ensemble:task-progress-config reset
```
